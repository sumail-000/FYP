...
class _UploadScreenState extends State<UploadScreen> {
  ...
  List<String> _departments = ['IT (Arfa Karim)']; // Will be populated dynamically
  List<String> _courseCodes = ['CS-101', 'IT-102']; // Will be populated dynamically
  List<String> _courses = ['SNA', 'OOP', 'DSA']; // Will be populated dynamically
  ...
  Future<void> _loadDepartments({bool forceRefresh = false}) async {
    try {
      final departments = forceRefresh 
  ...
  Future<void> _loadCourseCodes({bool forceRefresh = false}) async {
    try {
      final courseCodes = forceRefresh 
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: _showDetailsScreen ? _buildDetailsScreen() : _buildSelectionScreen(height),
      ),
    );
  }
  ...
  Widget _buildDetailsScreen() {
    ...
    return Theme(
      data: Theme.of(context).copyWith(
        buttonTheme: ButtonThemeData(
          alignedDropdown: true, // This forces dropdowns to align with their buttons
        ),
      ),
              ...
              children: [
                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: _documentSelectionFocusNode.hasFocus ? orangeColor : Colors.black,
                              width: _documentSelectionFocusNode.hasFocus ? 2 : 1,
                            ),
                          ),
                          child: Column(
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                  ...
                                  setState(() {
                                    _showDocumentSelectionDropdown = !_showDocumentSelectionDropdown;
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Icon(
                                          _getIconForType(_selectedFiles[_activeDocumentIndex].fileName),
                                          color: orangeColor,
                                          size: 18,
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        child: Text(
                                          _selectedFiles[_activeDocumentIndex].nameController.text,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15,
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return ListTile(
                                          ...
                                          selected: _activeDocumentIndex == index,
                                          selectedTileColor: blueColor.withOpacity(0.1),
                                          leading: Container(
                                            padding: EdgeInsets.all(6),
                                            decoration: BoxDecoration(
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _typeFieldFocusNode.hasFocus ? orangeColor : Colors.black,
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Icon(
                                  _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].type != null
                                    ? _getIconForDocType(_selectedFiles[_activeDocumentIndex].type)
                              ...
                              Expanded(
                                child: Text(
                                  _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].type != null
                                    ? _selectedFiles[_activeDocumentIndex].type!
                                    : 'Select Type',
                                  style: TextStyle(
                                    color: _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].type != null
                                      ? Colors.black
                                  ...
                                  onTap: () {
                                    ...
                                    setState(() {
                                      if (_applyToAllDocuments) {
                                        ...
                                        _selectedFiles[_activeDocumentIndex].type = type;
                                      }
                                      _showTypeDropdown = false;
                                    });
                                  },
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _categoryFieldFocusNode.hasFocus ? orangeColor : Colors.black,
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Icon(
                                  _getCategoryIcon(_selectedFiles.isNotEmpty ? _selectedFiles[_activeDocumentIndex].category : null),
                                  color: orangeColor,
                                  size: 18
                                ),
                              ),
                              ...
                              Expanded(
                                child: Text(
                                  _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].category != null
                                    ? _selectedFiles[_activeDocumentIndex].category!
                                    : 'Select Category',
                                  style: TextStyle(
                                    color: _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].category != null
                                      ? Colors.black
                                      : Colors.grey.shade600,
                                    fontSize: 15,
                                  ),
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  leading: Container(
                                    ...
                                    child: Icon(_getCategoryIcon(category), color: orangeColor, size: 18),
                                  ),
                                  title: Text(category),
                                  onTap: () {
                                    ...
                                    setState(() {
                                      if (_applyToAllDocuments) {
                                        ...
                                        // Apply only to active document
                                        _selectedFiles[_activeDocumentIndex].category = category;
                                      }
                                      _showCategoryDropdown = false;
                                    });
                                  },
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _semesterFieldFocusNode.hasFocus ? orangeColor : Colors.black,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].semester != null
                                    ? _selectedFiles[_activeDocumentIndex].semester!
                                    : 'Select Semester',
                                  style: TextStyle(
                                    color: _selectedFiles.isNotEmpty && _selectedFiles[_activeDocumentIndex].semester != null
                                      ? Colors.black
                                      : Colors.grey.shade600,
                                    fontSize: 15,
                                  ),
                                  ...
                                  onTap: () {
                                    ...
                                    setState(() {
                                      if (_applyToAllDocuments) {
                                        ...
                                        // Apply only to active document
                                        _selectedFiles[_activeDocumentIndex].semester = semester;
                                      }
                                      _showSemesterDropdown = false;
                                    });
                                  },
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _departmentFocusNode.hasFocus ? orangeColor : Colors.black,
                      ...
                      TextField(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            if (_selectedFiles.isNotEmpty) {
                              _selectedFiles[_activeDocumentIndex].department = value;
                            }
                          });
                        },
                                ...
                                return ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      if (_selectedFiles.isNotEmpty) {
                                        _selectedFiles[_activeDocumentIndex].department = dept;
                                      }
                                      _showDepartmentDropdown = false;
                                    });
                                    _setDepartment(dept);
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _courseFocusNode.hasFocus ? orangeColor : Colors.black,
                      ...
                      TextField(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            if (_selectedFiles.isNotEmpty) {
                              _selectedFiles[_activeDocumentIndex].course = value;
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  leading: Container(
                                    ...
                                    child: Icon(Icons.book, color: orangeColor, size: 18),
                                  ),
                                  title: Text(course),
                                  onTap: () {
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _courseCodeFocusNode.hasFocus ? orangeColor : Colors.black,
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: GestureDetector(
                            onTap: () {
                              // Toggle dropdown when clicking on suffix icon
                              setState(() {
                                _showCourseCodeDropdown = !_showCourseCodeDropdown;
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            if (_selectedFiles.isNotEmpty) {
                              _selectedFiles[_activeDocumentIndex].courseCodeController.text = value;
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  leading: Container(
                                    ...
                                    child: Icon(Icons.class_, color: orangeColor, size: 18),
                                  ),
                                  title: Text(code),
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      if (_selectedFiles.isNotEmpty) {
                                        _selectedFiles[_activeDocumentIndex].courseCodeController.text = code;
                                        
                                        // Apply to all documents if flag is set
                                        if (_applyToAllDocuments) {
                                          for (var doc in _selectedFiles) {
                                            doc.courseCodeController.text = code;
                                          }
                                        }
                                      }
                                      _showCourseCodeDropdown = false;
  ...
  void _selectFiles() async {
    try {
      ...
      FilePickerResult? result = await FilePicker.platform.pickFiles(
        type: FileType.any, // Change to allow any file type, we'll handle validation ourselves
        allowMultiple: true,
      );
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        // Valid extensions
        final List<String> validExtensions = ['pdf', 'doc', 'docx', 'ppt', 'pptx'];
        ...
        for (var file in result.files) {
          ...
          if (!isValidExtension) {
            errorMessages.add('${file.name}: Unsupported file format. Only PDF, DOC, DOCX, PPT, PPTX are supported.');
          } else if (!isValidSize) {
            errorMessages.add('${file.name}: File exceeds 10MB Cloudinary limit (${(file.size / (1024 * 1024)).toStringAsFixed(1)}MB).');
          } else {
            validFiles.add(file);
          }
        }
        ...
        if (validFiles.length > 10) {
          errorMessages.add('Too many files selected. Only the first 10 valid files will be processed.');
        ...
        if (errorMessages.isNotEmpty) {
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              ...
              final screenSize = MediaQuery.of(context).size;
              final double maxDialogHeight = screenSize.height * 0.4; // 40% of screen height
              final double maxDialogWidth = min(500.0, screenSize.width * 0.9); // Either 500 or 90% of width
                ...
                child: ConstrainedBox(
                  ...
                  child: Container(
                    ...
                    child: IntrinsicHeight(
                      child: Column(
                        mainAxisSize: MainAxisSize.min, // Important to prevent full-screen dialog
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Header with icon
                          Row(
                            children: [
                              Container(
                                padding: EdgeInsets.all(6), // Smaller padding for smaller screens
                                decoration: BoxDecoration(
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    color: blueColor,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16, // Smaller font for smaller screens
                                  ),
                                ),
                              ),
                            ],
                          ...
                          if (hasFormatError)
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.info_outline, color: blueColor, size: 16), // Smaller icon
                            ...
                            Expanded(
                              child: SingleChildScrollView(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  mainAxisSize: MainAxisSize.min,
                                  children: processedErrorMessages.map((message) => Padding(
        ...
        if (validFiles.isNotEmpty) {
          ...
          List<DocumentItem> newFiles = validFiles.map((file) {
            return DocumentItem.fromPlatformFile(file);
          }).toList();
          ...
          setState(() {
            ...
            if (_selectedFiles.isNotEmpty) {
              _departmentController.text = _selectedFiles[_activeDocumentIndex].department ?? '';
              _courseController.text = _selectedFiles[_activeDocumentIndex].course ?? '';
              _courseCodeController.text = _selectedFiles[_activeDocumentIndex].courseCodeController.text;
            }
          });
        } else {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('No valid files to upload. Please select valid documents.'),
  ...
  void _setDepartment(String department) {
    setState(() {
      ...
      if (_selectedFiles.isNotEmpty) {
        final previousDepartment = _selectedFiles[_activeDocumentIndex].department;
        ...
        if (previousDepartment != department && _selectedFiles[_activeDocumentIndex].course != null) {
  ...
  Future<void> _updateCourseCodeForDepartmentAndCourse(String department, String course) async {
    try {
      final courseCode = await _uploadService.getCourseCodeForDepartmentAndCourse(department, course);
      ...
      if (courseCode != null && courseCode.isNotEmpty) {
        setState(() {
          ...
          if (_selectedFiles.isNotEmpty) {
            _selectedFiles[_activeDocumentIndex].courseCodeController.text = courseCode;
  ...
  void _uploadFiles() async {
    ...
    final uploads = _selectedFiles.map((doc) {
      return {
        'filePath': doc.path!,
  ...
  List<String> _getFilteredCourseCodes() {
    ...
    return _courseCodes.where((code) => 
  ...
  Future<void> _addNewDepartmentIfNeeded() async {
    ...
    if (_isAddingDepartment) {
      print('Already adding department, ignoring duplicate call'); // Debug print
      return;
    }
  ...
  Future<void> _addNewCourseCodeIfNeeded() async {
    ...
    if (_isAddingCourseCode) {
      print('Already adding course code, ignoring duplicate call'); // Debug print
      return;
    }
    ...
    try {
      ...
      if (!_courseCodes.contains(courseCodeText)) {
        ...
        if (success) {
          print('Course code added successfully, reloading list'); // Debug print
          ...
          if (_selectedFiles.isNotEmpty) {
            setState(() {
              _selectedFiles[_activeDocumentIndex].courseCodeController.text = courseCodeText;
